 ...
 */
export declare const isUndefinedOrVoid: (val: unknown) => val is void | undefined;
type NullableKeys<T> = {
 ...
 */
export type NullableKeysToOptional<T> = Omit<T, NullableKeys<T>> & Partial<Pick<T, NullableKeys<T>>>;
/**
